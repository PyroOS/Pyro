...
#define AE_CONFIG "config/AttribEdit.cfg"
...
namespace ae
{
	    ...
	    m_nIsFileReq(false), m_pcAlert(NULL), m_pcPrefsWindow(NULL), m_pcAddEditWindow(NULL)
	{
		...
		m_pcOpenReq = new os::FileRequester(os::FileRequester::LOAD_REQ, new os::Messenger(this), NULL, os::FileRequester::NODE_FILE | os::FileRequester::NODE_DIR, false, new os::Message(ID_FILEREQ_OPEN), NULL, false, true, "Select");
		m_pcOpenReq->SetIcon(g_apcBitmap[AEBITMAP_FOLDER24X24]);
		m_pcOpenReq->Start();
		m_pcCopyReq = new os::FileRequester(os::FileRequester::LOAD_REQ, new os::Messenger(this), NULL, os::FileRequester::NODE_FILE | os::FileRequester::NODE_DIR, false, new os::Message(ID_FILEREQ_COPY), NULL, false, true, "Copy");
		m_pcCopyReq->SetIcon(g_apcBitmap[AEBITMAP_FOLDER24X24]);
		m_pcCopyReq->Start();
		m_pcNewReq = new os::FileRequester(os::FileRequester::SAVE_REQ, new os::Messenger(this), NULL, os::FileRequester::NODE_FILE, false, new os::Message(ID_FILEREQ_NEW), NULL, false, true, "Create");
