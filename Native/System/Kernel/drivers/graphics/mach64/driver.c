...
#define APPSERVER_DRIVER "mach64"

struct gfx_device g_sDevices[] = {
	{0x1002, 0x4354, "ATi", "Mach64 CT"},
	{0x1002, 0x4554, "ATi", "Mach64 ET"},
	{0x1002, 0x5654, "ATi", "Mach64 VT"},
	{0x1002, 0x5655, "ATi", "Mach64 VT"},
	{0x1002, 0x5656, "ATi", "Mach64 VT"},
	{0x1002, 0x4754, "ATi", "3D Rage"},
	{0x1002, 0x4755, "ATi", "3D Rage II+"},
	{0x1002, 0x4756, "ATi", "3D Rage IIC"},
	{0x1002, 0x4757, "ATi", "3D Rage IIC"},
	{0x1002, 0x475a, "ATi", "3D Rage IIC"},
	{0x1002, 0x4c54, "ATi", "3D Rage LT"},
	{0x1002, 0x4c47, "ATi", "3D Rage LT"},
	{0x1002, 0x4742, "ATi", "3D Rage PRO"},
	{0x1002, 0x4744, "ATi", "3D Rage PRO"},
	{0x1002, 0x4749, "ATi", "3D Rage PRO"},
	{0x1002, 0x4750, "ATi", "3D Rage PRO"},
	{0x1002, 0x4751, "ATi", "3D Rage PRO"},
	{0x1002, 0x4752, "ATi", "3D Rage XL"},
	{0x1002, 0x4c42, "ATi", "3D Rage LT PRO"},
	{0x1002, 0x4c44, "ATi", "3D Rage LT PRO"},
	{0x1002, 0x4c49, "ATi", "3D Rage LT PRO"},
	{0x1002, 0x4c50, "ATi", "3D Rage LT PRO"},
	{0x1002, 0x4c4d, "ATi", "3D Rage Mobility"},
	{0x1002, 0x4c4e, "ATi", "3D Rage Mobility"}
};
	...
	for ( nPCINum = 0; psBus->get_pci_info( &sInfo, nPCINum ) == 0; ++nPCINum )
	{
		for ( nDeviceNum = 0; nDeviceNum < nNumDevices; ++nDeviceNum )
		{
			...
			if ( sInfo.nVendorID == g_sDevices[nDeviceNum].nVendorID && sInfo.nDeviceID == g_sDevices[nDeviceNum].nDeviceID )
			{
				...
				/* Create node path */
				sprintf( zNodePath, "graphics/mach64_%i_0x%x_0x%x", nPCINum, ( uint )sInfo.nVendorID, ( uint )sInfo.nDeviceID );
