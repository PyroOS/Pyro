...
#define APPSERVER_DRIVER "mga"

struct gfx_device g_sDevices[] = {
	{0x102b, 0x0010, "Matrox", "Impression"},
	{0x102b, 0x0518, "Matrox", "Athena"},
	{0x102b, 0x0519, "Matrox", "Millennium"},
	{0x102b, 0x051a, "Matrox", "Mystique"},
	{0x102b, 0x0100, "Matrox", "Mystique"},
	{0x102b, 0x051e, "Matrox", "Mystique AGP"},
	{0x102b, 0x051b, "Matrox", "Millennium II"},
	{0x102b, 0x051f, "Matrox", "Millennium II"},
	{0x102b, 0x0d10, "Matrox", "Ultima"},
	{0x102b, 0x1000, "Matrox", "G100"},
	{0x102b, 0x1001, "Matrox", "G100"},
	{0x102b, 0x0520, "Matrox", "G200"},
	...
	for ( nPCINum = 0; psBus->get_pci_info( &sInfo, nPCINum ) == 0; ++nPCINum )
	{
		for ( nDeviceNum = 0; nDeviceNum < nNumDevices; ++nDeviceNum )
		{
			...
			if ( sInfo.nVendorID == g_sDevices[nDeviceNum].nVendorID && sInfo.nDeviceID == g_sDevices[nDeviceNum].nDeviceID )
			{
				...
				/* Create node path */
				sprintf( zNodePath, "graphics/mga_%i_0x%x_0x%x", nPCINum, ( uint )sInfo.nVendorID, ( uint )sInfo.nDeviceID );
