...
/** \brief Parses an FTP LIST request.
 * It outputs the listing using unix-style flags.
 *
 * \param fp The ftpparse structure to output the listing to.
 * \param buf The buffer that contains the FTP LIST results.
