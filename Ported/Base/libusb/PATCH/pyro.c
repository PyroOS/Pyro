 ...
 *
 * $Id: pyro.c,v 1.1 2007/08/16 17:48:21 kajdevos Exp $
 * $Name:  $
 *
...
{
  /* Pyro doesn't have the corresponding ioctl.  It is
...
int usb_resetep(usb_dev_handle *dev, unsigned int ep)
{
  ...
  USB_ERROR_STR(-ENOSYS, "usb_resetep called, unimplemented on Pyro");
}
...
int usb_reset(usb_dev_handle *dev)
{
  ...
  USB_ERROR_STR(-ENOSYS, "usb_reset called, unimplemented on Pyro");
}
