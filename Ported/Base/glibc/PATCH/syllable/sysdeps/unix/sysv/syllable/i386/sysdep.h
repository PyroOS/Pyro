...
/* For Pyro we can use the system call table in the header file /boot/Include/pyro/syscall.h
...
/* Pyro uses a negative return value to indicate syscall errors,
...
/* The orcalling convention for system calls on Pyro is
   to use int $0x80.  */
#define ENTER_KERNEL int $0x80

/* Pyro takes system call arguments in registers:
...
/* Pyro does not have TLS support but these macros are required */
#define PTR_MANGLE(var)
#define PTR_DEMANGLE(var)

#endif /* pyro/i386/sysdep.h */
